...
**Иконки**
1. Откройте в браузере (рекомендуется Яндекс-Браузер) сайт [flaticon.com](https://www.flaticon.com)
...
6. Выровняйте иконки и надписи к ним по левому краю - выбрав `Формат \ Выровнять \ Выровнять по левому краю`
