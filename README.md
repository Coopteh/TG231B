...
9. Вставьте 3 записи языком запросов SQL в таблицу `user`
```
...
```
4. В схеме данных (слева) найдите таблицу `user` и нажмите кнопку просмотра данных таблицы - иконка таблицы, рядом с названием
